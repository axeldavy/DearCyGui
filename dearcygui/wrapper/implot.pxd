...
cdef extern from "implot.h" namespace "ImPlot" nogil:
    ...
    void AnnotationV(double, double, ImVec4&, ImVec2&, bint, const char*, va_list)
    void TagX(double, ImVec4&, bint)
    void TagX(double, ImVec4&, const char*)
    void TagXV(double, ImVec4&, const char*, va_list)
    void TagY(double, ImVec4&, bint)
    void TagY(double, ImVec4&, const char*)
    void TagYV(double, ImVec4&, const char*, va_list)
    void SetAxis(ImAxis)
